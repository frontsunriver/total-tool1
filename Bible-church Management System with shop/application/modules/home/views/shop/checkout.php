        ...
        <div class="container">
            ...
            <?php foreach ($product as $product): ?>
                ...
                <div class="col-md-5 product-sidebar">
                    ...
                    <div class="form">
                        <form class="form-horizontal" action="<?php echo base_url(); ?>dashboard/shop/addtocart" method="post" enctype="multipart/form-data">
                            <input type="hidden" name="productID" value="<?php echo $product->productID; ?>">
                            <input type="hidden" name="price" value="<?php echo $product->price; ?>">
                            <input type="number" min="1" name="quantity" class="form-control quantity" placeholder="Quantity">
