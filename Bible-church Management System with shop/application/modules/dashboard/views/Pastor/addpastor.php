            ...
            <div class="xxxcol-md-offset-1 xxxcol-md-10">
                <div class="card">
                    <div class="card-header" data-background-color="purple">
                        <h4 class="title"><i class="material-icons">people</i> <?php echo $this->lang->line('dash_addpastor_panel_title'); ?></h4>
                        <p class="category">(*) <?php echo $this->lang->line('dash_gpanel_mfar'); ?></p>
                    </div>
                    <div class="card-content">

                        <form id="addPastorForm" class="form-horizontal" action="<?php echo base_url(); ?>dashboard/pastor/addnewpastor" method="post" enctype="multipart/form-data">
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group label-floating is-empty">
                                        ...
                                        <input type="text" id="bpdate" name="bpdate" class="datepicker form-control" required>
                                        <span class="material-input"></span></div>
                                </div>
                            </div>
                            ...
                            <button id="addPastorSubmit" type="submit" class="btn btn-primary pull-right"><i class="material-icons">person_add</i> <?php echo $this->lang->line('dash_addpastor_panel_title'); ?></button>
