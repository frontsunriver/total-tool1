                ...
                <div class="xxxcol-md-offset-1 xxxcol-md-10">
                    <div class="card">
                        <div class="card-header" data-background-color="purple">
                            <h4 class="title"><i class="material-icons">person_add</i> <?php echo $this->lang->line('dash_updateprofile_panel_title'); ?></h4>
                        ...
                        <div class="card-content">
                            ...
                            <form id="updateUserForm" class="form-horizontal" action="<?php echo base_url(); ?>dashboard/user/update" method="post" enctype="multipart/form-data">
                                ...
                                <button id="updateUserSubmit" type="submit" class="btn btn-primary pull-right"><i class="material-icons">person_add</i> <?php echo $this->lang->line('dash_updateprofile_panel_title'); ?></button>
