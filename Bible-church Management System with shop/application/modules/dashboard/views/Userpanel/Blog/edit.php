            ...
            <div class="xxxcol-md-offset-1 xxxcol-md-10">
                <div class="card">
                    ...
                    <div class="card-content">
                        ...
                        <form id="updateUserBlogForm" class="form-horizontal" action="<?php echo base_url(); ?>dashboard/blog/update" method="post" enctype="multipart/form-data">
                            <div class="row">                                
                                <div class="col-md-12">
                            ...
                            <button id="updateUserBlogSubmit" type="submit" class="btn btn-primary pull-right"><i class="material-icons">speaker_notes</i> <?php echo $this->lang->line('dash_updateblog_panel_title'); ?></button>
