                            ...
                            <tbody>
                                ...
                                foreach ($event as $row) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo base_url(); ?>home/event/view/<?php echo $row->eventid; ?>" class="btn btn-primary"><i class="material-icons">call_made</i> <?php echo $this->lang->line('dash_gpanel_view'); ?></a>
