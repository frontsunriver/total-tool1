            ...
            <div class="xxxcol-md-offset-1 xxxcol-md-10">
                <div class="card">
                    <div class="card-header" data-background-color="purple">
                        <h4 class="title"><i class="material-icons">person_add</i> <?php echo $this->lang->line('dash_updatestaff_panel_title'); ?></h4>
                        <p class="category">(*) <?php echo $this->lang->line('dash_gpanel_mfar'); ?></p>
                    </div>
                    <div class="card-content">

                        <form id="updateStaffForm" class="form-horizontal" action="<?php echo base_url(); ?>dashboard/staff/addnewstaff" method="post" enctype="multipart/form-data">
                            <?php foreach ($individual as $row): ?>
                                ...
                                <input type="hidden" id="staffid" name="staffid" value="<?php echo $row->staffid; ?>">
                                <div class="row">
                                    <div class="col-md-4">
                                ...
                                <button id="updateStaffSubmit" type="submit" class="btn btn-primary pull-right"><i class="material-icons">person_add</i> <?php echo $this->lang->line('dash_updatestaff_panel_title'); ?></button>
