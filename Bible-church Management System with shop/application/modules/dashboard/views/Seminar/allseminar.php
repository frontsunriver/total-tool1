                ...
                if ($this->uri->segment(4)) {
                    ...
                    <div class="card card-product">
                        ...
                        <div class="card-content">
                            ...
                            <h4 class="card-title">
                                <a href="<?php echo base_url(); ?>home/seminar/view/<?php echo $row->seminarid; ?>"><?php echo word_limiter($row->seminartitle, 5); ?></a>
                            </h4>
                        ...
                        <div class="card-footer">
                            <div class="pull-right">
                                <a href="<?php echo base_url(); ?>home/seminar/view/<?php echo $row->seminarid; ?>" class="btn btn-primary"><i class="material-icons">call_made</i> <?php echo $this->lang->line('dash_gpanel_view'); ?></a>
