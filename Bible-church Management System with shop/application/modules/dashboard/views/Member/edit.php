            ...
            <div class="xxxcol-md-offset-1 xxxcol-md-10">
                <div class="card">
                    <div class="card-header" data-background-color="purple">
                        <h4 class="title"><i class="material-icons">people</i> <?php echo $this->lang->line('dash_updatemember_panel_title'); ?></h4>
                        <p class="category">(*) <?php echo $this->lang->line('dash_gpanel_mfar'); ?></p>
                    </div>
                    <div class="card-content">

                        <form id="updateMemberForm" class="form-horizontal" action="<?php echo base_url(); ?>dashboard/member/update" method="post" enctype="multipart/form-data">
                            <div class="row">
                            ...
                            <button id="updateMemberSubmit" type="submit" class="btn btn-primary pull-right"><i class="material-icons">person_add</i> <?php echo $this->lang->line('dash_updatemember_panel_title'); ?></button>
