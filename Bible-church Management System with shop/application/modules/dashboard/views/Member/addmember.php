            ...
            <div class="xxxcol-md-offset-1 xxxcol-md-10">
                <div class="card">
                    <div class="card-header" data-background-color="purple">
                        <h4 class="title"><i class="material-icons">people</i> <?php echo $this->lang->line('dash_addmember_panel_title'); ?></h4>
                    ...
                    <div class="card-content">
                        ...
                        <form id="addMemberForm" class="form-horizontal" action="<?php echo base_url(); ?>dashboard/member/addnewmember" method="post" enctype="multipart/form-data">
                            ...
                            <button id="addMemberSubmit" type="submit" class="btn btn-primary pull-right"><i class="material-icons">person_add</i> <?php echo $this->lang->line('dash_addmember_panel_title'); ?></button>
