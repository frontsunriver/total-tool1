                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        <form id="addBlogForm" class="form-horizontal" action="<?php echo base_url(); ?>dashboard/blog/addnewblog" method="post" enctype="multipart/form-data">
                            ...
                            <button id="addBlogSubmit" type="submit" class="btn btn-primary pull-right"><i class="material-icons">speaker_notes</i> <?php echo $this->lang->line('dash_addblog_panel_title'); ?></button>
