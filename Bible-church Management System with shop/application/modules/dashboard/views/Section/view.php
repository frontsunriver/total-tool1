			...
			<div class="col-md-offset-1 col-md-10">
				<div class="card card-profile">
					<div class="card-avatar">						
						<img class="img" src="<?php echo base_url();?>assets/assets/images/pastor/profile/<?php echo $row->profileimage;?>" alt="<?php echo $row->fname;?>">
					...
					<div class="card-content">
						...
						<div class="row">
							<div class="action-btn">
								<a href="<?php echo base_url();?>dashboard/pastor/edit/<?php echo $row->pastorid;?>" class="btn btn-warning btn-sm"><?php echo $this->lang->line('dash_gpanel_edit');?></a>
								<a href="<?php echo base_url();?>dashboard/pastor/delete/<?php echo $row->pastorid;?>" class="btn btn-danger btn-sm delete"><?php echo $this->lang->line('dash_gpanel_delete');?></a>
							</div>
						</div>
					</div>
				</div>
