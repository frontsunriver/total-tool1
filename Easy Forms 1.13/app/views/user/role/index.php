...
<?= GridView::widget(
    [
        ...
        'panel' => [
            ...
            'heading' => Yii::t('app', 'Roles') .' <small class="panel-subtitle hidden-xs">'.
                ...
                'buttons' => [
                    ...
                    'delete' => function ($url) {
                        $options = array_merge([
                            ...
                            'data-confirm' => Yii::t('app', 'Are you sure you want to delete this role? All data related to this item will be deleted. This action cannot be undone.'),
                            'data-method' => 'post',
                            'data-pjax' => '0',
                        ], []);
                        return '<li>'.Html::a(
