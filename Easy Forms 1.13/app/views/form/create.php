...
$options = array(
    ...
    "initPoint" => Url::to(['ajax/init-form', 'template' => $template]),
    "endPoint" => Url::to(['ajax/create-form']),
            ...
            <div id="actions">
                ...
                <div class="btn-group dropup">
                    <button type="button" class="btn btn-default saveForm"
                            data-endpoint="<?= Url::to(['ajax/create-form']) ?>"
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"
                                title="<?= Yii::t('app', 'Create another form') ?>">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="list-group">
                            <a href="<?= $url = Url::to(['form/update']); ?>" id="toUpdate" class="list-group-item">
                                <h4 class="list-group-item-heading"><?= Yii::t("app", "It's Ok.") ?></h4>
                                <p class="list-group-item-text">
                                    <?= Yii::t("app", "I still want to edit this form.") ?></p></a>
                            <a href="<?= $url = Url::to(['form/settings']); ?>" id="toSettings" class="list-group-item">
                            ...
                            <a href="<?= $url = Url::to(['form/share']); ?>" id="toPublish" class="list-group-item">
                                <h4 class="list-group-item-heading">
